...
**Last updated:** 13 August 2026 (P4 stage 15 - six network defaults measured from the city's own OSM tags and the walk beeline factor split and measured; issues #33, #25, #23 closed)
...
`config/registry/<city>/` holds 200 fields with units, provenance and a sweep or a
