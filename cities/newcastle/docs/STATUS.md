...
| Open issues | **12** — #5 #9 #14 #20 #24 #28 #29 #30 #31 #32 #34 #37. **#36 closed 15 Aug**, verified already done: zero `WICKHAM_` occurrences and the package is `citysim`. **Every one of the remaining twelve is a HYPOTHESIS until re-measured** — see [`ISSUE_ASSESSMENT_BRIEF.md`](handover/ISSUE_ASSESSMENT_BRIEF.md). |
