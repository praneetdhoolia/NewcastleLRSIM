...
**Last updated:** 18 August 2026 (**the two demand defects are fixed**: the escort tour now binds to the person being escorted (§9.46, task 4.2.5) and the population age structure is census-conditioned (§9.47, task 4.2.6 — ~40,000 phantom elderly commuters removed, ~27,000 missing 75+ persons restored, child/tertiary student status from observed attendance); B1/B2/plans/run-inputs regenerated; **next: the 25% re-measure arm**) · branch `praneetdhoolia/age-structure-escort-binding`
