...
# Every value below comes from cities/<city>/registry/, not a literal in this
...
SIGNALS = _city.path('data/processed/corridor/A2_signal_control_corridor.csv')
RESTRICTIONS = _city.path('data/processed/network/A2_turn_restrictions_resolved.csv')
E1_ROAD_VARIANTS = _city.path('scenarios/E1_road_variants.csv')
E1_SCENARIOS = _city.path('scenarios/E1_scenarios.csv')
PARKING = _city.path('data/processed/network/A5_parking_osm.csv')
